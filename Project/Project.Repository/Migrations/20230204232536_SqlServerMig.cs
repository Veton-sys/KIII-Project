        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayedFor = table.Column<bool>(nullable: false),
                    DateAdded = table.Column<DateTime>(nullable: true),
                    PriceForRepair = table.Column<double>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceOfUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeviceOfUser_ServiceDevices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "ServiceDevices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeviceOfUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceOfUser_DeviceId",
                table: "DeviceOfUser",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceOfUser_UserId",
                table: "DeviceOfUser",
                column: "UserId");
